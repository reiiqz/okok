...
task.spawn(function() 
	pcall(function()
		...
		if queue_on_teleport then
			local UltraHubSCRIPT = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/reiiqz/okok/main/okok.lua"))()'
